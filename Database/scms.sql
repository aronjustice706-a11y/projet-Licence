...
(0, 'Reactif de Laboratoire'),
(1, 'Appareil de Laboratoire'),
(2, 'Solution de Laboratoire'),
(3, 'Tests Rapides'),
(4, 'Matériel chirurgical et Accouchement'),
(5, 'Dispositif de chirurgie et urologie'),
(6, 'Premiers soins'),
(7, 'Appareil de chirurgie'),
(9, 'Autres....');
