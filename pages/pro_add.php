                      ...
                      <div class="table-responsive">
                        ...
                        <form role="form" method="post" action="pro_transac.php?action=add">
                            <div class="form-group">
                              <input class="form-control" placeholder="Code du produit" name="prodcode" required>
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nom du produit" name="name" required>
                            </div>
                            <div class="form-group">
                              <textarea rows="5" cols="50" texarea" class="form-control" placeholder="Description du produit" name="description" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="datet" class="form-control" placeholder="Date de stockage" name="datestock" required>
                            </div>
                            <hr>
                            <button type="submit" class="btn btn-success btn-block"><i class="fa fa-check fa-fw"></i>Enregistrer</button>
                            <button type="reset" class="btn btn-danger btn-block"><i class="fa fa-times fa-fw"></i>Mettre a jours</button>
